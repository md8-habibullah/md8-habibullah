...
| :--- | :---: | :--- | :--- |
| [top-github-repos-list](https://github.com/md8-habibullah/top-github-repos-list) | 127 | - | A curated list of top open-source GitHub repositories across various categories to help developers discover… |
| [GPG-keys-with-GitHub](https://github.com/md8-habibullah/GPG-keys-with-GitHub) | 8 | - | A step-by-step ultimate guide to generating, configuring, and using GPG keys with Git and GitHub to sign co… |
| [awesome-senior-engineer-resources](https://github.com/md8-habibullah/awesome-senior-engineer-resources) | 3 | - | 🧠 300+ advanced open-source repos for senior & staff engineers - distributed systems, databases, Kubernete… |
| [awesome-learn-to-code](https://github.com/md8-habibullah/awesome-learn-to-code) | 3 | - | 🌱 157 beginner-friendly open-source repos to learn to code - roadmaps, free courses & books, project-based… |
